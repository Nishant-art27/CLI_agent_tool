...
A **conversational CLI agent** that clones websites by generating fully working HTML, CSS, and JavaScript files. Powered by Google's Gemini 2.0 Flash (free tier) and built with a ReAct (Reasoning + Acting) agent loop.
...
- **Runtime**: Node.js (ESM)
- **AI Model**: Google Gemini 2.0 Flash (via OpenAI-compatible endpoint)
- **Libraries**: openai, chalk, ora, axios, dotenv, open
